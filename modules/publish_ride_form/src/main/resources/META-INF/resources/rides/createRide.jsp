...
<portlet:actionURL name="/rideapp/createride/add" var="ridesActionURL">
...
<body>
	<div class="container">
		<div class="row">
			...
			<form name="fm" action="<%=ridesActionURL.toString()%>"
						...
						<div id="stopovers">
							...
							<div class="container p-0">
								<div class="row">
									<div class="mb-3 col-6">
										<input type="time" class="form-control" id="time">
										<div class="form-text">When will you arrive at this
											stopover?</div>
									</div>
									<div class="mb-3 col-6">
										<input type="time" class="form-control" id="time">
										<div class="form-text">When will you depart from this
											stopover?</div>
									</div>
								</div>
							</div>
				...
				<div class="col-md-6 col-sm-3 offset-md-3">
					<div class="form-check">
						<input class="form-check-input" type="checkbox" value="true"
							id="addRide"> <label class="form-check-label"
							for="addRide"> Add return ride </label>
					</div>
				</div>

				<div class="col-md-6 col-sm-3 offset-md-3 " style="display: none;"
					id="addRideForm">
					<!-- Ride Details -->
					<div class="card p-3 mb-2">
						<div class="card-header mb-2">
