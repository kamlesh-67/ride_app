...
/**
 * The base model interface for the returnRide service. Represents a row in the &quot;Rideapp_returnRide&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation <code>com.rideapp.publishride.model.impl.returnRideModelImpl</code> exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in <code>com.rideapp.publishride.model.impl.returnRideImpl</code>.
 * </p>
 *
 ...
 */
@ProviderType
public interface returnRideModel
	extends BaseModel<returnRide>, GroupedModel, ShardedModel {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a return ride model instance should use the {@link returnRide} interface instead.
	 */
