...
/**
 * Provides the local service interface for returnRide. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see returnRideLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface returnRideLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.rideapp.publishride.service.impl.returnRideLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the return ride local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link returnRideLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public returnRide addreturnRide(returnRide returnRide);
	...
	public returnRide createreturnRide(long returnRideId);
	...
	public returnRide deletereturnRide(long returnRideId)
		throws PortalException;
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public returnRide deletereturnRide(returnRide returnRide);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public returnRide fetchreturnRide(long returnRideId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public returnRide getreturnRide(long returnRideId) throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<returnRide> getreturnRides(int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public returnRide updatereturnRide(returnRide returnRide);
