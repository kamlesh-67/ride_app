...
/**
 * Provides the local service utility for bookings. This utility wraps
 * <code>com.rideapp.publishride.service.impl.bookingsLocalServiceImpl</code> and
 ...
 * @generated
 */
public class bookingsLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.rideapp.publishride.service.impl.bookingsLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static bookings addbookings(bookings bookings) {
		return getService().addbookings(bookings);
	}
	 ...
	 */
	public static bookings createbookings(long bookingsId) {
		return getService().createbookings(bookingsId);
	}
	 ...
	 */
	public static bookings deletebookings(bookings bookings) {
		return getService().deletebookings(bookings);
	}
	 ...
	 */
	public static bookings deletebookings(long bookingsId)
		throws PortalException {

		return getService().deletebookings(bookingsId);
	}
	...
	public static bookings fetchbookings(long bookingsId) {
		return getService().fetchbookings(bookingsId);
	}
	 ...
	 * @throws PortalException if a bookings with the primary key could not be found
	 */
	public static bookings getbookings(long bookingsId) throws PortalException {
		return getService().getbookings(bookingsId);
	}
	 ...
	 */
	public static List<bookings> getbookingses(int start, int end) {
		return getService().getbookingses(start, end);
	}
	 ...
	 */
	public static int getbookingsesCount() {
		return getService().getbookingsesCount();
	}
	 ...
	 */
	public static bookings updatebookings(bookings bookings) {
		return getService().updatebookings(bookings);
	}

	public static bookingsLocalService getService() {
		return _service;
	}

	private static volatile bookingsLocalService _service;
