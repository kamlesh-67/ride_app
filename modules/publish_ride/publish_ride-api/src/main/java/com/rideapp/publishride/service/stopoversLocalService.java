...
/**
 * Provides the local service interface for stopovers. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see stopoversLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface stopoversLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.rideapp.publishride.service.impl.stopoversLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the stopovers local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link stopoversLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public stopovers addstopovers(stopovers stopovers);
	...
	public stopovers createstopovers(long stopoversId);
	...
	public stopovers deletestopovers(long stopoversId) throws PortalException;
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public stopovers deletestopovers(stopovers stopovers);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public stopovers fetchstopovers(long stopoversId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public stopovers getstopovers(long stopoversId) throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<stopovers> getstopoverses(int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public stopovers updatestopovers(stopovers stopovers);
