...
/**
 * Provides the local service utility for vehicals. This utility wraps
 * <code>com.rideapp.publishride.service.impl.vehicalsLocalServiceImpl</code> and
 ...
 * @generated
 */
public class vehicalsLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.rideapp.publishride.service.impl.vehicalsLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static vehicals addvehicals(vehicals vehicals) {
		return getService().addvehicals(vehicals);
	}
	 ...
	 */
	public static vehicals createvehicals(long vehicalsId) {
		return getService().createvehicals(vehicalsId);
	}
	 ...
	 */
	public static vehicals deletevehicals(long vehicalsId)
		throws PortalException {

		return getService().deletevehicals(vehicalsId);
	}
	 ...
	 * @return the vehicals that was removed
	 */
	public static vehicals deletevehicals(vehicals vehicals) {
		return getService().deletevehicals(vehicals);
	}
	...
	public static vehicals fetchvehicals(long vehicalsId) {
		return getService().fetchvehicals(vehicalsId);
	}
	 ...
	 * @throws PortalException if a vehicals with the primary key could not be found
	 */
	public static vehicals getvehicals(long vehicalsId) throws PortalException {
		return getService().getvehicals(vehicalsId);
	}
	 ...
	 */
	public static List<vehicals> getvehicalses(int start, int end) {
		return getService().getvehicalses(start, end);
	}
	 ...
	 */
	public static int getvehicalsesCount() {
		return getService().getvehicalsesCount();
	}
	 ...
	 */
	public static vehicals updatevehicals(vehicals vehicals) {
		return getService().updatevehicals(vehicals);
	}

	public static vehicalsLocalService getService() {
		return _service;
	}

	private static volatile vehicalsLocalService _service;
